...
public class TestImg7UnitTest {
    ...
    public void whatAngleDoesItReturn() throws IOException {
        ...
        image = Imgcodecs.imread((new File(".\\src\\test\\resource\\test_cases\\7.jpg")).getCanonicalPath());
        ...
        for(HatchTarget hatchTarget : hatchTargets) {
            ...
            assertEquals(29.5, hatchTarget.rangeInInches(), 1);
        }
