...
public class TestImg6UnitTest {
    ...
    public void whatAngleDoesItReturn() throws IOException {
        ...
        image = Imgcodecs.imread((new File(".\\src\\test\\resource\\test_cases\\6.jpg")).getCanonicalPath());
        ...
        for(HatchTarget hatchTarget : hatchTargets) {
            ...
            assertEquals(53.5, hatchTarget.rangeInInches(), 1);
        }
